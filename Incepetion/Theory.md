1. What is emmit?
-> Emmit is an essential development tool that helps the developer to write the repetative code structure in minimal typing.

2. What is the difference between library and framework?
-> Library target to the specific functionality whereas frameworks tries to provide everything required the bulid complete application.

3. what is CDN? Why do we use it.
-> a content delivery network refers to the geographically distributed group of servers that work together to provide the fast delivery of the internet content. The main use of cdn is to deliver the internet content in fast and secure way.
